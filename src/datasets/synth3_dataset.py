...
class SynthDataset(InMemoryDataset):
    """
    Dataset for synthetic molecules from synth3.csv
    """
    atom_encoder = None
    atom_decoder = None
    atom_types = None
    ...
    def processed_dir(self):
        return osp.join(self.root, 'synth3', 'processed')
    ...
    def download(self):
        ...
        target_path = osp.join(self.raw_dir, 'synth3.csv')
    ...
    def process(self):
        ...
        for split in ['train', 'val', 'test']:
            ...
            for idx in indices:
                ...
                score_columns = [
                    "score_ch0_cl0","score_ch0_cl1","score_ch0_cl2","score_ch0_cl3",
                    "score_ch0_cl4","score_ch0_cl5","score_ch0_cl6","score_ch0_cl7",
                    "score_ch0_cl8","score_ch0_cl9","score_ch0_cl10","score_ch0_cl11",
                    "score_ch0_cl12","score_ch0_cl13","score_ch0_cl14","score_ch0_cl15",
                    "score_ch1_cl16","score_ch1_cl17","score_ch1_cl18","score_ch1_cl19",
                    "score_ch1_cl20","score_ch1_cl21","score_ch1_cl22",
                ]

                for col in score_columns:
                    properties.append(float(row[col]) if col in row else 0.0)
...
class SynthDataModule(MolecularDataModule):
    def __init__(self, cfg):
        ...
        self.csv_path = "/hkfs/work/workspace_haic/scratch/rx3495-workspace_C/DeFoG/data/synth3/raw/synth3.csv"
    ...
    def __init__(self, datamodule, cfg, recompute_statistics=False):
        ...
        if self.remove_h:
            ...
            if recompute_statistics:
                ...
                #self.node_types = torch.tensor([0.0000, 0.0000, 0.0000, 0.0042, 0.7749, 0.0140, 0.0000, 0.0000, 0.0085,
                #    0.0000, 0.0000, 0.0000, 0.0000, 0.0008, 0.0000, 0.0000, 0.1133, 0.0623,
                #    0.0010, 0.0000, 0.0000, 0.0210, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
                #    0.0000, 0.0000]) 
                ...
                self.valency_distribution = torch.zeros(94)
