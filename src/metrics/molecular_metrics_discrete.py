...
# Generische Klasse für alle Atome
class GenericAtomCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


# Oder spezifische Klassen für jedes Atom (wie im Original)
...
# Füge Klassen für deine zusätzlichen Atome hinzu
class AluminiumCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class ArsenicCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class CobaltCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class ChromiumCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class GalliumCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class GermaniumCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class MercuryCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class ManganeseCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class MolybdenumCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class LeadCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class RheniumCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class AntimonyCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class TinCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class TelluriumCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class UraniumCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class TungstenCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
...
class AtomMetricsCE(MetricCollection):
    def __init__(self, dataset_infos):
        ...
        # Erweitere das class_dict mit allen deinen Atomen
        class_dict = {
            "H": HydrogenCE,
            "C": CarbonCE,
            "N": NitroCE,
        ...
        for i, atom_type in enumerate(atom_decoder):
            # Fallback: Wenn ein Atom nicht im class_dict ist, verwende GenericAtomCE
            if atom_type in class_dict:
                metrics_list.append(class_dict[atom_type](i))
            else:
                print(f"Warning: No specific class for atom '{atom_type}', using GenericAtomCE")
                metrics_list.append(GenericAtomCE(i))
...
class BondMetricsCE(MetricCollection):
    def __init__(self):
        ...
        ce_DO = DoubleCE(2)
        ce_TR = TripleCE(3)
        # ce_AR = AromaticCE(4)  # Aktiviere wenn du aromatische Bindungen hast
