...
class GraphTransformer(nn.Module):
    ...
    def forward(self, X, E, y, node_mask):
        ...
        #print("y shape before time embedding: ", y.shape)
        #print("y : ", y)
        time_t = y[:, -1].unsqueeze(-1)  # Shape: (batch_size, 1)
        time_emb = timestep_embedding(time_t, 64)
        ...
        #print("y end forwardpass GT: ", y)
        #print("mask: ", node_mask)
